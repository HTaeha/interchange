...
type MyibcdexPacketData struct {
	...
	//	*MyibcdexPacketData_BuyOrderPacket
...
type MyibcdexPacketData_BuyOrderPacket struct {
...
func (*MyibcdexPacketData_BuyOrderPacket) isMyibcdexPacketData_Packet()   {}
...
func (m *MyibcdexPacketData) GetBuyOrderPacket() *BuyOrderPacketData {
	if x, ok := m.GetPacket().(*MyibcdexPacketData_BuyOrderPacket); ok {
...
func (*MyibcdexPacketData) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*MyibcdexPacketData_BuyOrderPacket)(nil),
...
func (*BuyOrderPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_63622f42d7523591, []int{6}
}
...
func (*BuyOrderPacketAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_63622f42d7523591, []int{7}
}
...
func init() {
	...
	proto.RegisterType((*BuyOrderPacketData)(nil), "coreators.interchange.myibcdex.BuyOrderPacketData")
	proto.RegisterType((*BuyOrderPacketAck)(nil), "coreators.interchange.myibcdex.BuyOrderPacketAck")
}
...
var fileDescriptor_63622f42d7523591 = []byte{
	...
	,
}
...
func (m *MyibcdexPacketData_BuyOrderPacket) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MyibcdexPacketData_BuyOrderPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MyibcdexPacketData_BuyOrderPacket) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MyibcdexPacketData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Packet = &MyibcdexPacketData_BuyOrderPacket{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
