...
const baseMyibcdexPacketData: object = {};

export const MyibcdexPacketData = {
  encode(
    message: MyibcdexPacketData,
  ...
  decode(input: Reader | Uint8Array, length?: number): MyibcdexPacketData {
    ...
    const message = { ...baseMyibcdexPacketData } as MyibcdexPacketData;
