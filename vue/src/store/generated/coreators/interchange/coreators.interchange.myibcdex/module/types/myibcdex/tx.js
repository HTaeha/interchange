...
export class MsgClientImpl {
    ...
    SendCreatePair(request) {
        ...
        const promise = this.rpc.request("coreators.interchange.myibcdex.Msg", "SendCreatePair", data);
    ...
    SendSellOrder(request) {
        ...
        const promise = this.rpc.request("coreators.interchange.myibcdex.Msg", "SendSellOrder", data);
    ...
    SendBuyOrder(request) {
        ...
        const promise = this.rpc.request("coreators.interchange.myibcdex.Msg", "SendBuyOrder", data);
    ...
    CancelSellOrder(request) {
        ...
        const promise = this.rpc.request("coreators.interchange.myibcdex.Msg", "CancelSellOrder", data);
    ...
    CancelBuyOrder(request) {
        ...
        const promise = this.rpc.request("coreators.interchange.myibcdex.Msg", "CancelBuyOrder", data);
